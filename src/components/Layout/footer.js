...
const FooterLinks = ({title,links}) => {
    ...
    <div>
      <h2 className="title-font font-medium text-black font-bold text-lg tracking-widest text-sm mb-3 ">{title}</h2>
...
const Footer = () => {
  ...
  <div className="container px-5 mx-auto flex justify-between flex-wrap">
    <div className="flex gap-4">
      ...
      <p className="mt-2 text-sm text-gray-500 max-w-sm text-sm">LUCHOW is a decentralized digital currency that can be used as a medium of exchange or to facilitate a trade. It is a borderless democratic form of digital money </p>
      </div>
    </div>
    <div className="flex">
    ...
    <div className="flex mt-8 justify-between w-full items-center">
        <p className="text-red-dark text-sm">Copyright © 2021, LunaChow LLC | All Rights Reserved</p>
